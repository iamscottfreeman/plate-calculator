  ...
  return (
    <div className='mt-10'>
      ...
      <div className='flex justify-between align-middle'>
        <label
          className={`flex items-center bg-gray-800 text-white border-2 px-4 py-4 mr-2 cursor-pointer select-none ${
        ...
        <label
          className={`block bg-gray-800 text-white border-2 px-4 py-2 cursor-pointer ${
